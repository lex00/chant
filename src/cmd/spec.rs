...
//!
//! Handles all spec-related operations including:
//! - Creating, listing, showing, and deleting specs
//! - Status checking and linting
//! - Spec splitting, archiving, and merging
//!
//! Note: Spec execution (single and parallel) is handled by cmd::work module
...
mod tests {
    use super::*;
    use crate::cmd::work::{
        append_agent_output, finalize_spec, get_commits_for_spec, get_model_name,
        get_model_name_with_default, re_finalize_spec, CommitError, MAX_AGENT_OUTPUT_CHARS,
    };
