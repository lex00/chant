...
Team with approval requirements for spec execution. See the [Approval Workflow guide](approval-workflow.md) for complete documentation on the approval process, rejection handling modes, and workflow examples.
