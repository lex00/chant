...
- [x] `tracks` field parses correctly in frontmatter
- [x] `type: documentation` is a valid spec type
- [x] Lint warns if documentation spec missing `tracks`
- [x] Lint warns if documentation spec missing `target_files`
- [x] Auto-selects `documentation` prompt if available
- [x] All existing tests pass
- [x] New tests for documentation type validation