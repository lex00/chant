...
- [x] Config schema supports multiple agents with per-agent limits
- [x] Parallel distributes work across configured agents
- [x] Respects per-agent and total concurrency limits
- [x] Detects common parallel pitfalls after execution
- [x] Reports clear summary of parallel results
- [x] Cleanup prompt created and effective
- [x] Agent-assisted cleanup is optional and configurable
- [x] Tests for distribution logic
- [x] Tests for pitfall detection
