...
- [x] `informed_by` field parses correctly in frontmatter
- [x] `origin` field parses correctly in frontmatter
- [x] `type: research` is a valid spec type
- [x] Lint warns if research spec missing both `informed_by` and `origin`
- [x] Lint warns if research spec missing `target_files`
- [x] Auto-selects appropriate research prompt if available
- [x] All existing tests pass
- [x] New tests for research type validation