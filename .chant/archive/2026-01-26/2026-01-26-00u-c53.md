...
- [x] Drivers (type: driver/group) excluded from coupling check
- [x] Member specs warned only for sibling references
- [x] Regular specs warned for any spec ID reference (existing behavior)
- [x] Tests for driver exclusion
- [x] Tests for member-sibling detection
