...
Migrated test_mcp_spec_list_archive, test_in_progress_status, and test_commands to TestHarness/SpecFactory. Added SpecFactory methods: as_markdown_with_approval(), as_markdown_approved(). All tests pass.
