...
- [x] Create custom merge driver script/binary
- [x] Merge driver parses frontmatter from both sides
- [x] Merge driver intelligently resolves status conflicts
- [x] Merge driver preserves implementation content
- [x] Add .gitattributes entry for spec files
- [x] Document merge driver installation
- [x] Test: merge spec with status conflict resolves automatically
- [x] Test: merge spec with body changes preserves code
