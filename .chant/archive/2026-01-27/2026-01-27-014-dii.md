...
commits:
- 4e21944
completed_at: 2026-01-27T23:59:26Z
model: opus
---
...
- [x] Add "Custom Merge Driver for Specs" section to CLAUDE.md
- [x] Document what the driver does and why it's useful
- [x] Provide installation instructions (automatic + manual)
- [x] Explain when the driver activates
- [x] Add verification steps
- [x] Include troubleshooting section
- [x] Add brief mention in Best Practices section
