...
commits:
- f30cd46
completed_at: 2026-01-27T23:59:25Z
model: opus
---
...
- [x] Add "Merge Conflict Resolution" section to CLAUDE.md
- [x] Document conflict type detection
- [x] Show example of enhanced error message
- [x] Explain each recovery option (manual, --rebase, --auto)
- [x] Add to "Key Principles" or "Best Practices" section
