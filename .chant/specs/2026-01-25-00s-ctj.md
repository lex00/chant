...
- [ ] Move fmt/lint/test steps to BEFORE commit in Instructions
- [ ] Add explicit "verify git status is clean" step after commit
- [ ] Remove redundant lint mentions from Constraints section
- [ ] Test by working a spec and verifying no uncommitted changes remain
