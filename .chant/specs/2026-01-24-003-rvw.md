...
- [ ] Read `defaults.branch` from config.md and use it in cmd_work
- [ ] Read `defaults.pr` from config.md and use it in cmd_work
- [ ] CLI flags (`--branch`, `--pr`) should override config defaults
- [ ] The config fields already exist in DefaultsConfig, just need to be used
