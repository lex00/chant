...
- [ ] Write log file header before agent starts
- [ ] Stream stdout to log file as it arrives (not buffered until end)
- [ ] `chant log -f` works during active `chant work` execution
- [ ] Log file still contains complete output after execution
