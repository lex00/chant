...
- [ ] Decide Option A (automatic) or Option B (prompt)
- [ ] Update `chant init` to call merge-driver-setup
- [ ] Handle errors gracefully (warn but don't fail init)
- [ ] Test init in new repo (merge driver should be active)
- [ ] Update docs to mention merge driver is automatic
- [ ] All tests passing
