...
- [ ] Warning headline changed to indicate mismatch, not missing changes
- [ ] Show declared target_files that had no changes
- [ ] Show actual files that were changed (with line counts if available)
- [ ] Reorder "may indicate" list: benign causes first, serious causes last
- [ ] Add "To fix" suggestion
- [ ] Unit test for warning message formatting
