...
```
🟢 Ready    - All dimensions pass
🟡 Review   - Some dimensions need attention
🔴 Refine   - Significant issues, refine before work
```
...
```
00d-vao: 🟡 Review | Complexity: B | Confidence: C | Splittable: A
00e-xyz: 🟢 Ready  | Complexity: A | Confidence: A | Splittable: B
00f-abc: 🔴 Refine | Complexity: D | Confidence: D | Splittable: C
         → 12 criteria, walls of text, suggest refining before work
```

### `chant split`
Before splitting, check splittability. After splitting, score isolation:
```
Split quality: 🟡 Review
...
```
Warning: Spec 00d-vao has quality 🔴 Refine
