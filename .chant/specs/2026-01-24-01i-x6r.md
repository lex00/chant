...
- [x] Parse subtask title from agent output (e.g., "## Subtask 1: Title Here")
- [x] Write `# Title` as first line of subtask body
- [x] Strip annotations from target_files (remove parenthetical comments)
- [x] Add default acceptance criteria to each subtask
- [x] Test with `01e-o0l` - clean split with proper titles and criteria
- [x] All tests pass