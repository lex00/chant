...
- [x] First test: Directory with no git repository
- [x] Test verifies chant add still succeeds
- [x] Test verifies branch-derived fields are omitted
- [x] Test verifies non-git fields (path) still work
- [x] Second test: Detached HEAD state
- [x] Test verifies graceful handling (no crash)
- [x] Tests pass: `cargo test test_derivation.*git`
