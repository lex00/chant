...
- [ ] Add `{{spec.path}}` substitution in `src/prompt.rs`
- [ ] Update step 8 in `standard.md` to say: "Edit `{{spec.path}}` to check off criteria"
- [ ] Add test for `{{spec.path}}` substitution
