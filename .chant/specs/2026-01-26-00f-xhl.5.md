...
- [x] Adds `replayed_at` timestamp on successful replay
- [x] Increments `replay_count` (initializes to 1 if first replay)
- [x] Preserves `original_completed_at` from first completion
- [x] Updates are atomic with replay execution success
- [x] Frontmatter format remains valid YAML
