...
- [ ] Add "Configuration for OSS Maintainers" section to oss-workflow.md
- [ ] Document `chant silent` command (replaces `--silent` init flag)
- [ ] Document `branch: false` and `main_branch` config
- [ ] Include example config.yaml snippets
