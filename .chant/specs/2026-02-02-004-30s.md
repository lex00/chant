...
- [ ] `offset` parameter added for incremental reads
- [ ] Response includes `byte_offset` for next read
- [ ] `since` parameter filters by timestamp (optional, lower priority)
- [ ] Backwards compatible (existing calls work)
