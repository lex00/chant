...
- [ ] Create `.chant/prompts/extensions/output-concise.md` with guidance above
- [ ] Add `prompt_extensions: [output-concise]` to `.chant/config.md`
- [ ] Verify extension is appended to assembled prompts
- [ ] Test with `chant work` on a simple spec and confirm reduced verbosity
