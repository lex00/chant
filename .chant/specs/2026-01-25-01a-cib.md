...
- [x] Update Cargo.toml to use rustls for ollama-rs
- [x] `cargo build --release` succeeds locally
- [x] Verify OpenSSL is not in dependency tree: `cargo tree | grep -i openssl` returns nothing
- [x] All tests pass (119 passed)
- [x] Commit the fix
