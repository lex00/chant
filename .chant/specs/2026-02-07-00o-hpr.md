...
- [ ] `test_mcp_spec_list_archive.rs` uses TestHarness
- [ ] `test_in_progress_status.rs` uses SpecFactory for spec creation
- [ ] `test_commands.rs` uses SpecFactory (no local `create_spec()`)
