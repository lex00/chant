...
- src/cmd/work.rs
- src/spec.rs
completed_at: 2026-01-27T23:25:02Z
model: opus
---
...
- [ ] Add BlockingDependency struct to spec.rs
- [ ] Add get_blocking_dependencies() method to Spec
- [ ] Method reloads dependency specs from disk for fresh status
- [ ] Update cmd_work error message to use new format
- [ ] Show dependency status indicator (●○◐)
- [ ] Show dependency title
- [ ] Show current status
- [ ] Show completed_at if dependency is completed
- [ ] Add warning if dependency is complete but spec still blocked
- [ ] Include actionable next steps in error
- [ ] Add unit test for get_blocking_dependencies()
- [ ] Add integration test: blocked spec shows detailed error
