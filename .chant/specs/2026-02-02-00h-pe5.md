...
- [ ] `./test-examples.sh research-workflow` runs both academic-path and developer-path
- [ ] Script detects sub-path structure automatically
- [ ] Each sub-path runs independently with its own chant context
- [ ] Assertions run for each sub-path
