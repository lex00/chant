...
- [ ] `main.rs` is under 500 LOC
- [ ] Argument definitions live in a separate module (`src/cli.rs` or similar)
- [ ] Each command dispatch is a single function call (no inline business logic in match arms)
- [ ] Configuration is loaded once and passed to commands
- [ ] All existing tests pass
- [ ] Binary behavior is identical (no user-visible changes)