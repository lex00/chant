...
- [ ] `compare_spec_ids` parses and compares sequence numerically
- [ ] `010-xxx` sorts after `00z-xxx` on same date
- [ ] Existing member number sorting preserved
- [ ] Add test case for base36 rollover sorting
- [ ] `chant list` shows specs in correct order after 36+ specs/day
