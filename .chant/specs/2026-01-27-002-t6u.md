...
- [ ] Merge command detects non-TTY stdin
- [ ] When non-interactive, merge proceeds without prompting
- [ ] Message logged: "Non-interactive mode detected, proceeding without confirmation"
- [ ] Interactive mode still prompts as before
- [ ] `--yes` flag continues to work as expected
- [ ] Tests verify TTY detection behavior
