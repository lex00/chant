...
- [ ] Add `branch_is_behind_main` helper to detect divergence
- [ ] Add `rebase_branch_onto_main` helper
- [ ] Add `abort_rebase` helper for cleanup on failure
- [ ] Update `merge_and_cleanup_in_dir` to attempt rebase before merge
- [ ] Abort rebase cleanly if conflicts detected
- [ ] Return to main branch after rebase (success or failure)
- [ ] Add `--no-rebase` flag to parallel execution
- [ ] Log when auto-rebase occurs
- [ ] Add tests for rebase scenarios
