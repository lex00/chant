...
- [ ] Common single-word coupling keyword removed from `COUPLING_KEYWORDS`
- [ ] Coupling keywords (if kept) are a factor, not an automatic Grade D override
- [ ] A spec with 2 target files and 6 AC does not score red on splittability alone
- [ ] Existing splittability tests updated to match new behavior
- [ ] `cargo test` passes
