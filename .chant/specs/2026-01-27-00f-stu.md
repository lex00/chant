...
- [x] First test: No enterprise config at all
- [x] Second test: Enterprise config with empty derived map
- [x] Both tests verify spec creation succeeds
- [x] Both tests verify NO derived_fields in frontmatter
- [x] Both tests verify normal spec fields present (type, status, etc.)
- [x] Tests pass: `cargo test test_no_derivation`
