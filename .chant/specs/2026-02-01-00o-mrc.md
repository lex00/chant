...
- [ ] Diagnose checks worktree paths when worktree exists for spec
- [ ] Diagnose shows correct status from worktree spec file
- [ ] Diagnose finds lock file in worktree
- [ ] Diagnose finds log file in worktree
- [ ] Output indicates which location was checked
- [ ] Running agents no longer show as "failed" in diagnose