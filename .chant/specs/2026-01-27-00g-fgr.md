...
- [x] Test creates spec without enterprise config
- [x] Test adds enterprise config after spec creation
- [x] Test runs `chant derive <SPEC_ID>` command
- [x] Test verifies spec file is updated with derived fields
- [x] Test verifies success message in stdout
- [x] Test verifies derived_fields tracking added
- [x] Test passes: `cargo test test_chant_derive_single_spec`
