...
- [x] `chant merge` (no args) launches wizard when mergeable specs exist
- [x] Wizard shows multi-select list of completed specs with branches
- [x] Wizard prompts for rebase strategy
- [x] Wizard prompts for branch deletion
- [x] Direct mode `chant merge 001` still works
- [x] Shows "No specs to merge" message if none available
