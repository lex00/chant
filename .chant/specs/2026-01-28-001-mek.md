...
- [ ] Add `--all-completed` to basic examples in cli.md
- [ ] Add "Post-Parallel Convenience" subsection explaining the flag
- [ ] Explain difference between `--all` and `--all-completed`
- [ ] Show post-parallel workflow example
- [ ] Check if guides/recovery.md needs update
