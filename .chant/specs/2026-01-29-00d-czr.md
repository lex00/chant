...
ACCEPTANCE CRITERIA:
- [ ] All three new features documented in CHANGELOG.md
- [ ] CLAUDE.md updated with chain and approval workflow guidance
- [ ] README.md mentions new features
- [ ] CLI help text accurate for --chain flag
- [ ] docs/ directory has examples of new features (if relevant)
- [ ] No outdated information about finalization or chain behavior
