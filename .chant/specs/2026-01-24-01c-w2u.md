...
- [ ] Add `Split` subcommand to CLI
- [ ] Split invokes agent to analyze spec and create subtasks
- [ ] Subtasks use `{parent-id}.N` naming convention
- [ ] Subtasks have appropriate `depends_on` relationships
- [ ] Parent spec type changes to `group` after split
- [ ] Parent marked complete when all subtasks complete
- [ ] `chant list` shows subtask hierarchy
