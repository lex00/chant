...
- [ ] Add `find_project_root()` function in src/mcp.rs
- [ ] Update `mcp_ensure_initialized()` to use absolute path from project root
- [ ] MCP tools work correctly when cwd differs from project directory
- [ ] `cargo test` passes