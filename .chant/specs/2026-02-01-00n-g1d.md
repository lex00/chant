...
- [ ] `is_failed()` checks for commits before flagging failure
- [ ] Specs with matching commits are NOT marked as failed
- [ ] Specs with no commits AND unchecked criteria ARE marked as failed
- [ ] Tests cover both true positive and false positive scenarios
- [ ] `cargo test` passes
