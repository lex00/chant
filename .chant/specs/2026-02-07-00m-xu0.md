...
- [ ] `tests/integration/workflow_test.rs` is deleted
- [ ] Both tests exist in `config_test.rs` and pass
- [ ] Tests use TestHarness instead of manual `/tmp` paths and `common.rs`
