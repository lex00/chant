...
- [ ] Integration test that reproduces the bug
- [ ] Fix uses absolute paths where needed
- [ ] Test passes - `chant list --status in_progress` shows working specs
- [ ] Verified in user's project
