...
- [ ] Add `--parallel` flag to work command
- [ ] When used without spec ID, execute all ready specs in parallel
- [ ] Spawn multiple agent processes concurrently
- [ ] Stream output from all agents (prefixed with spec ID)
- [ ] Wait for all agents to complete
- [ ] Report summary of results (passed/failed counts)
- [ ] Update docs/reference/cli.md with examples
