...
completed_at: 2026-01-27T21:11:54Z
model: sonnet
---
...
- [ ] First test: All env vars missing
- [ ] Test verifies command succeeds
- [ ] Test verifies env-derived fields omitted
- [ ] Test verifies non-env fields still work
- [ ] Second test: Some env vars set, others missing
- [ ] Test verifies partial derivation (only available vars)
- [ ] Tests pass: `cargo test test.*env_var`
