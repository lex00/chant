...
target_files:
- src/cmd/work.rs
completed_at: 2026-01-27T21:16:30Z
model: haiku
---
...
- [ ] Identify where sequential execution calls finalize
- [ ] Add finalize_spec() call in parallel execution path
- [ ] Extract commits from spec branch after parallel work
- [ ] Update spec frontmatter with all metadata fields
- [ ] Save finalized spec to disk
- [ ] Add logging: "✓ Finalized {spec_id}"
- [ ] Integration test: parallel work -> verify status: completed in frontmatter
- [ ] Integration test: parallel work -> verify commits, completed_at, model present
- [ ] Integration test: parallel work -> chant list shows ● completed
