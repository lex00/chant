...
**Cleanup Strategy:**
- ✅ Cleanup immediately after spec succeeds
- ⏳ Keep worktree if spec failed (for debugging)
- 🗑️ Add `chant cleanup` command for manual pruning
- ⚠️ Log cleanup operations for transparency
