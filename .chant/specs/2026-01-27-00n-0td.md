...
- [x] Test branch names with /, -, . characters
- [x] Test env var values with spaces and quotes
- [x] Test paths with dots and hyphens
- [x] Test values containing regex metacharacters
- [x] All tests verify exact value preservation
- [x] Tests pass: `cargo test test.*special_characters`