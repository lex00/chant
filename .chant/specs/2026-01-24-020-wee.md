...
- [ ] Check `depends_on` field - all listed specs must be `completed`
- [ ] Member specs: prior siblings must be completed (.1 before .2)
- [ ] Show clear error listing which dependencies are blocking
- [ ] Add `--force` flag to bypass dependency check
