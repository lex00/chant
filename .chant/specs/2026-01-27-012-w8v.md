...
- [x] Create src/cmd/refresh.rs module
- [x] Add Refresh command to main.rs Commands enum
- [x] Implement cmd_refresh function
- [x] Reload all specs from disk (no caching)
- [x] Recalculate ready/blocked status for all specs
- [x] Print summary: total, completed, ready, blocked counts
- [x] Add --verbose flag to list ready and blocked specs
- [x] Show blocking dependencies in verbose mode
- [x] Add to help text: `chant --help` shows refresh command
- [x] Add integration test: complete spec -> refresh -> dependent shows ready
- [x] Update documentation with refresh command usage
