...
- [ ] Standard prompt includes guidance on out-of-scope issue handling
- [ ] Standard prompt includes duplicate spec prevention
- [ ] Instructions use `just chant add` (not direct binary)
- [ ] Agent is told to continue original task after creating spec
