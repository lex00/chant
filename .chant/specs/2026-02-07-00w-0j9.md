...
- [x] `docs/architecture/operations-layer.md` exists
- [x] Covers problem, architecture diagram, all 4 current operations, contributor guide
- [x] Added to SUMMARY.md under Architecture section
- [x] `mdbook build docs/` succeeds (if available)

## Output

Created docs/architecture/operations-layer.md with architecture diagram, all 4 operations documented, contributor guide, and decision matrix.
