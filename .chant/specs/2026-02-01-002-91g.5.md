...
- [ ] Create src/cmd/work/ directory with mod.rs and 4 execution mode submodules
- [ ] Move single-spec execution to single.rs
- [ ] Move chain execution logic to chain.rs
- [ ] Move parallel execution to parallel.rs
- [ ] Move wizard to wizard.rs
- [ ] Update src/cmd/mod.rs and delete original work.rs
