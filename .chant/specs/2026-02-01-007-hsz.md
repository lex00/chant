...
- [ ] After worktree creation, spec file is copied from main to worktree
- [ ] Worktree spec has status: in_progress
- [ ] `chant list --status in_progress` shows specs being worked in worktrees
- [ ] Fix applies to both parallel.rs and single.rs (if applicable)
- [ ] Add test case verifying worktree spec has correct status
