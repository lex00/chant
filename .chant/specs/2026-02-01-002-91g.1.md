...
- [ ] Add get_commits_in_range(from_ref, to_ref) to git.rs returning Vec<CommitInfo>
- [ ] Add get_commit_changed_files(hash) to git.rs returning Vec<String>
- [ ] Add get_recent_commits(count) to git.rs returning Vec<CommitInfo>
