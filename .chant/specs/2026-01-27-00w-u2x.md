...
- [x] Update merge error messages with context
- [x] Add "Next Steps" section to all error messages
- [x] Show relevant branch/commit info in errors
- [x] Provide 2-3 recovery options for each error type
- [x] Add examples of what to run
- [x] Include links to relevant help text
- [x] Test each error path outputs improved message
- [x] Update documentation with common error scenarios