...
The `assemble_with_context()` variant exists and injects an "isolated worktree" section into the prompt — but it's only used by the parallel execution path. Single-mode agents get no worktree awareness.
