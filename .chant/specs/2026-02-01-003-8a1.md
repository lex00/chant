...
**Acceptance Criteria:**
- [ ] Provides section includes `### Provides` header in output
- [ ] Function signatures render correctly in member specs
...
**Acceptance Criteria:**
- [ ] Independent members numbered before dependent members
- [ ] Topological sort respects dependency chains
- [ ] No more "appears late in sequence" warnings for correctly ordered specs
...
**Acceptance Criteria:**
- [ ] Member specs with <200 words don't warn about complexity
- [ ] Or: Group members skip word-count warnings entirely
- [ ] Existing lint behavior preserved for non-member specs
...
**Acceptance Criteria:**
- [ ] Member specs include reference to original task
- [ ] Reference survives in frontmatter or markdown comment
- [ ] Traceability maintained after dependency reordering
